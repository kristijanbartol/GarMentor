...
from configs.param_configs import TRAIN_TEMPLATE
...
GARMENT_MODEL = 'dn'
_C.MODEL = CfgNode()
_C.MODEL.GARMENT_MODEL = GARMENT_MODEL
_C.MODEL.NUM_IN_CHANNELS = 22 - (2 if GARMENT_MODEL == 'dn' else 0)
#_C.MODEL.NUM_IN_CHANNELS = 5 - (2 if GARMENT_MODEL == 'dn' else 0)
_C.MODEL.NUM_RESNET_LAYERS = 50
_C.MODEL.EMBED_DIM = 256
_C.MODEL.NUM_IMAGE_FEATURES = 2048
_C.MODEL.FC1_DIM = 512         # try increasing/decresing this one
...
_C.MODEL.OUTPUT_SET = 'shape-style'
_C.MODEL.PRETRAINED = False
_C.MODEL.DETERMINISTIC = False
_C.MODEL.USE_STYLE = True
#_C.MODEL.NUM_STYLE_PARAMS = 4
_C.MODEL.NUM_STYLE_PARAMS = 32 if GARMENT_MODEL == 'dn' else 4
...
_C.TRAIN.SYNTH_DATA.AUGMENT.USE_PREEXTRACTED = True
_C.TRAIN.SYNTH_DATA.AUGMENT.APPLY_FLAG = True
