...
_C.TRAIN.SYNTH_DATA.AUGMENT.SMPL.SHAPE_MIN = -3.0
_C.TRAIN.SYNTH_DATA.AUGMENT.SMPL.SHAPE_MAX = 3.0

_C.TRAIN.SYNTH_DATA.AUGMENT.GARMENTOR = CfgNode()
_C.TRAIN.SYNTH_DATA.AUGMENT.GARMENTOR.NUM_GARMENT_CLASSES = 4
_C.TRAIN.SYNTH_DATA.AUGMENT.GARMENTOR.STYLE_STD = 0.25
_C.TRAIN.SYNTH_DATA.AUGMENT.GARMENTOR.STYLE_MIN = -0.75
_C.TRAIN.SYNTH_DATA.AUGMENT.GARMENTOR.STYLE_MAX = 0.75
