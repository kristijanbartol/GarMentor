...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.FLAG = False
...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.JOINTS_SWAP_PROB = 0.
...
_C.TRAIN.SYNTH_DATA.AUGMENT.PROXY_REP.CHECK_JOINTS_OCCLUDED = False
...
_C.LOSS.STAGE1.WEIGHTS.STYLE = 50.0
