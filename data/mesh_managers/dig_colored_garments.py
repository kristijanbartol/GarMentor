...
class DigColoredGarmentsMeshManager(MeshManager):
    ...
    def create_meshes(
        ...
        '''
        verts_list = [
            dig_output.body_verts,
            dig_output.upper_verts,
            dig_output.lower_verts
        ]
        faces_list = [
            dig_output.body_faces,
            dig_output.upper_faces,
            dig_output.lower_faces
        ]
