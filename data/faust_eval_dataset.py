...
class FaustPartialEvalDataset(Dataset):
    def __init__(self,
                 faust_dir_path,
                 config,
                 visible_joints_threshold=None):
        super(FaustPartialEvalDataset, self).__init__()

        self.scans_dir = f'{faust_dir_path}/scans'
        self.registrations_dir = f'{faust_dir_path}/registrations'
        self.partial_indices_pth = f'{faust_dir_path}/FAUST_partial_view_indices'
