...
if __name__ == '__main__':
    ...
    parser.add_argument('--pose_shape_weights', '-W3D', type=str, default='/data/hierprob3d/model_files/poseMF_shapeGaussian_net_weights.tar')
    parser.add_argument('--pose_shape_cfg', type=str, default=None)
    parser.add_argument('--pose2D_hrnet_weights', '-W2D', type=str, default='/data/hierprob3d/model_files/pose_hrnet_w48_384x288.pth')
